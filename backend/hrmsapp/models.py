...
class AboutMe(models.Model):
    ...
    photo = models.ImageField(upload_to='photos/', blank=True, null=True)  # File upload for JPG/JPEG images
...
class HRDetails(models.Model):
    ...
    hr_social_media = models.URLField(max_length=255, null=True, blank=True)
...
class HiringDetails(models.Model):
    job_roles = models.CharField(max_length=100)  # Adjusted to a CharField with choices
    qualification = models.CharField(max_length=100)
    gender = models.CharField(max_length=10, choices=[('male', 'Male'), ('female', 'Female'), ('other', 'Other')])
    area_of_interest = models.CharField(max_length=100)
    specialization = models.CharField(max_length=100)
    experience = models.PositiveIntegerField()  # Using PositiveIntegerField for numeric representation
    passed_out = models.PositiveIntegerField()  # Using PositiveIntegerField for numeric representation
    age_no_ratio = models.PositiveIntegerField()  # Using PositiveIntegerField for numeric representation
    location = models.CharField(max_length=100)
    work_type = models.CharField(max_length=20)
    no_of_vacancies = models.PositiveIntegerField()  # Using PositiveIntegerField for clarity
    salary_details = models.CharField(max_length=100)
    no_of_vacancy_required = models.PositiveIntegerField()  # Using PositiveIntegerField for clarity
